...
import { AnimatedBeamDemo } from "@/components/example/animated-beam-multiple-outputs-demo";
...
const features = [
  {
    ...
    description: "We automatically save your notes",
    href: "#",
    cta: "Learn more",
  ...
  },
  {
    Icon: CalendarIcon,
    name: "Creation date",
    description: "All your notes have your creation date.",
    className: "col-span-3 lg:col-span-1",
    href: "#",
    cta: "Learn more",
    background: (
